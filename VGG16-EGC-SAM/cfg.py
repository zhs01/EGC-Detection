...
def parse_args():    
    ...
    parser.add_argument('-exp_name', type=str, default='test_model', help='net type')
    parser.add_argument('-prompt_approach', type=str, default='points_grids', help='the prompt approach: random_click or '
                                                                          'points_grids')
    ...
    parser.add_argument('-weights', type=str, default = 'logs/*EGCtrain*_2023_09_11_16_21_09/Model/checkpoint_best.pth', help='the weights file you want to test')
